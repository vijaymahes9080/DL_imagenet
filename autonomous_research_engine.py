...
class AutonomousResearchEngine:
    ...
    def should_stop(self, metrics):
        ...
        # Stop if performance is high and stable (Mandate: 94% for ResNet50)
        if val_acc >= 0.94 and mastery_score >= 95:
            return True, "Mastery achieved (>94% Accuracy, >95 Mastery Score)"
