...
| 4 | `04_model_architectures_comparison.ipynb` | ResNet50 vs Custom CNN benchmarking. |
...
*   **XAI Heatmaps**: If Grad-CAM heatmaps are blurry, try adjusting the `last_conv_layer_name` (e.g., `conv5_block3_out` for ResNet50).
